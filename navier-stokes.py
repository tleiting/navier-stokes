...
fluid_diffusion_rate = 0.0001 # how quickly the fluid spreads through its medium
flow_diffusion_rate = 0.0001 # how quickly flows spread through the medium (a measure of viscosity)
stencil = [[4, 0], [0, 4, [-4, 0], [0, -4]]
